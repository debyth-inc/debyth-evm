...
contract DeployScript is Script {
    ...
    function run() external {
        ...
        bytes memory initData = abi.encodeWithSelector(Mandate.initialize.selector, deployer, supportedTokens);

        // Deploy proxy
        TransparentUpgradeableProxy proxy = new TransparentUpgradeableProxy(address(implementation), deployer, initData);
